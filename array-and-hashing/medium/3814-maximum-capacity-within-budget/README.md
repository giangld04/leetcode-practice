...
2. Build a prefix array where prefMax[i] stores the maximum capacity among machines with index .
3. For selecting one machine, take the maximum capacity among all machines with cost .
4. For selecting two machines, fix machine i and binary search the largest index j  with costs[j] .
